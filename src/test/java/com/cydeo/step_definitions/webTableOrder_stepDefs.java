...
public class webTableOrder_stepDefs {
    ...
    public void user_enters_quantity(Integer int1) {
        ...
        // accepting int arg and sending text using sendKey() method
        // sinde sendKeys() method only accepts String, we need to either concat with ""
    ...
    public void user_enters_zipcode(String string) {
        webTableOrderPage.inputZipcode.sendKeys(string);
    }
    ...
    public void user_enters_expiry_date(String string) {
        webTableOrderPage.inputExpireDay.sendKeys(string);
    }
